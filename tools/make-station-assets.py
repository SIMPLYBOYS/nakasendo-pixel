...
用法：python3 tools/make-station-assets.py assets/32-seba.jpg [--crop L,T,R,B]
預設自動偵測畫芯裁掉紙邊（tools/plate.py）；--crop 可手動覆寫（各邊裁掉的比例）。
"""
...
def main():
    ...
    if args.crop:
        ...
        im = plate.crop(im)   # 紙邊留著會被 dither 打成雜訊點
